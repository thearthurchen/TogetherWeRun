...
contract StravaClient is Ownable, ChainlinkClient {
    ...
    */
     ...
     */
    function requestStravaData(address user) external returns (bytes32 requestId)
    {
     ...
     */
    function fulfill(bytes32 requestId, address user, uint timestamp, uint8 distance) public recordChainlinkFulfillment(requestId)
    {
